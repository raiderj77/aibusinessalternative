...
export const metadata: Metadata = {
  title: 'AI Tools Directory | AI Business Alternative',
  description:
    'Browse and compare our AI tools directory across 12 categories. Filter by pricing, rating, and category to find the perfect AI tool for your business.',
  openGraph: {
    title: 'AI Tools Directory | AI Business Alternative',
    description:
      'Browse and compare our AI tools directory across 12 categories. Filter by pricing, rating, and category to find the perfect AI tool for your business.',
...
export default function ToolsPage() {
  const itemListJsonLd = {
    ...
    description: `Browse and compare ${tools.length} AI tools across 12 categories`,
    ...
    <>
      ...
      <section className="py-10 border-b border-black/10">
        <div className="container-custom">
          <div className="mb-4">
            <span className="badge badge-blue">{tools.length} tools · 12 categories</span>
          </div>
          ...
          <p className="mt-3 text-[17px] text-gray-500 max-w-xl">
            Browse and compare {tools.length} AI tools across 12 categories
          </p>
        </div>
      </section>
