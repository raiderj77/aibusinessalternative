...
export default function AboutPage() {
  return (
    <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      ...
      <section className="mt-12"><h2 className="text-2xl font-bold text-gray-950">What is published now</h2><p className="mt-4 leading-7 text-gray-700">The homepage, About, Contact, Privacy, and Terms pages explain the project and its current operating state. Generated content routes are retained as a noindex research archive and show a review notice instead of the unsupported buying copy.</p></section>
